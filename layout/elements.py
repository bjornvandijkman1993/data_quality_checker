...
def outliers_vs_non_outliers(outliers, non_outliers):
    ...
    st.markdown(
        f"<table style='width: 100%; font-size:14px;  border: 0px solid gray; border-spacing: 10px;  "
        ...
        f"<td style='border-right: 2px solid {_border_color}; border-spacing: 10px; "
        f"{_number_format + 'color:red'}' > {outliers}</td> "
