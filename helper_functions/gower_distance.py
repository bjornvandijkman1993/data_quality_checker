...
z = np.array([[0,10, 11],[10,10, 10],[20,20, 20],[10,0, 0]])
print(z)

# get the squareform
square = squareform(pdist(y))
print(square)

# convert back to 1 vector
vector = squareform(square)

# length of vector is 1.5x number of rows of ndarray
print(len(vector), len(square))
...
X=pd.DataFrame({'age':[21,21,19, 30,21,21,19,30,15],
'gender':['M','M','N','M','F','F','F','F','M'],
'civil_status':['MARRIED','SINGLE','SINGLE','SINGLE','MARRIED','SINGLE','WIDOW','DIVORCED','WIDOW'],
'salary':[3000.0,1200.0 ,32000.0,1800.0 ,2900.0 ,1100.0 ,10000.0,1500.0,1200],
'has_children':[1,0,1,1,1,0,0,1,0],
'available_credit':[2200,100,22000,1100,2000,100,6000,2200,2300]})
